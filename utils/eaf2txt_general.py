"""
###
NOTE: Based on DiViMe/utils/eaf2txt.py - only minor changes (order and identity of columns in output, tiers considered) between the two scripts
=> could be an argument in the original script
###

This script converts an eaf file into a txt file containing the following information :

speaker speaker-tier onset offset receiver transcription
